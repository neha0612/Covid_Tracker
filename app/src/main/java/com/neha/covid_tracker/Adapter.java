package com.neha.covid_tracker;
...
import java.util.List;
    ...
    public class Adapter extends ArrayAdapter<Model> {
        ...
        public Adapter(Context context, List<Model> ModelList) {
            super(context, R.layout.activity_testing, ModelList);
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_testing, null, true);
            ...
            TextView migratedother = v.findViewById(R.id.migratedother);
            TextView deceased = v.findViewById(R.id.deceased);
            TextView recovered = v.findViewById(R.id.recovered);

            TextView delta = v.findViewById(R.id.delta);
